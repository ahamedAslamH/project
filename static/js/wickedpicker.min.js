  ...
  $.extend(Wickedpicker.prototype, {
    showPicker: function (e) {
      ...
      if (
        ...
        (r.hours = n[0]),
          (r.minutes = n[1]),
          (r.meridiem = o),
          this.options.showSeconds && (r.seconds = n[2]),
          this.setTime(r);
      }
      this.timepicker
        .css({
    ...
    hideTimepicker: function (e) {
      this.timepicker.hide(),
        "function" == typeof this.options.afterShow &&
          this.options.afterShow(e, this.timepicker),
        {
          start: function () {
            var e = $.Deferred();
            return (
      ...
      this.options.clearable && t.makePickerInputClearable(e),
        ...
        $(e).on("click focus", function (e) {
          $(t.timepicker).is(":hidden") &&
            (t.showPicker($(this)),
            (window.lastTimePickerControl = $(this)),
            $(t.hoursElem).focus());
        });
      var i = function (e) {
        if ($(t.timepicker).is(":visible")) {
          if ($(e.target).is(t.close))
            t.hideTimepicker(window.lastTimePickerControl);
          else if (
            $(e.target).closest(t.timepicker).length ||
            $(e.target).closest($(".hasWickedpicker")).length
          )
            e.stopPropagation();
          else {
            if (
              ("function" == typeof t.options.onClickOutside
                ? t.options.onClickOutside()
                : console.warn("Type of onClickOutside must be a function"),
              !t.options.closeOnClickOutside)
            )
              return;
            t.hideTimepicker(window.lastTimePickerControl);
          }
    ...
    parseHours: function (e) {
      return !1 === this.options.twentyFour
        ? ((e + 11) % 12) + 1
        : e < 10
        ? "0" + e
        : e;
    ...
    setMeridiem: function (e) {
      var t = "";
      (t = void 0 === e ? ("PM" === this.getMeridiem() ? "AM" : "PM") : e),
    ...
    formatTime: function (e, t, i, s) {
      ...
      return (
        this.options.showSeconds && (o += this.options.timeSeparator + s),
        !1 === this.options.twentyFour && (o += " " + i),
        o
      );
    },
